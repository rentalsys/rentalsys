                       ...
                       <form action="<?php echo URL_BASE . "saida/salvar" ?>" method="Post" enctype="multipart/form-data" class="theme-form mega-form">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="col-6">
                            ...
                            <input id="preco" class="form-control" name="valor_saida" type="text" placeholder="Preço" value="" readonly>
                          </div>
                           <script>
                           function recalcula() {
                      ...
                      <div class="modal-dialog" role="document">
                       ...
                       <form action="<?php echo URL_BASE . "saida/salvar" ?>" method="Post" enctype="multipart/form-data" class="theme-form mega-form">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="col-6">
							<label class="col-form-label">Preço</label>
                            <input id="preco<?php echo $entra->id_saida ?>" class="form-control" name="valor_saida" type="text" placeholder="Preço" value="<?php echo number_format($entra->valor_saida,2,",","."); ?>" readonly>
                          </div>
                           <script>
