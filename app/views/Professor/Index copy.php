                       ...
                       <div class="col-6">
                          ...
                          <input type="hidden" name="data_fim1" value="<?php echo $fimBR; ?>">
                           <input type="hidden" name="pesquisar" value="sim">
                            ...
                            <button type="submit" class="btn btn-primary" id="cadEvent" name="cadEvent" value="cadEvent">Reservar Horário</button>
                          </div>
                        </div>
                        </form>
                      </div>
                    ...
                    <div class="modal fade" id="exampleModalfat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-lg" role="document">
                    	...
                    	<div class="modal-content">
                          ...
                          <div class="form-group row">
                          <div class="col-6">
                          <label for="select-1">Responsável: <span id="lancamento"></span></label>
                          </div>
                          <div class="col-6">
