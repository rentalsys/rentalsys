...
$idFormato= filter_input(INPUT_POST,'id_formatoEdit',FILTER_DEFAULT);
$idTipo= filter_input(INPUT_POST,'id_tipo',FILTER_DEFAULT);
$idConfirmado= filter_input(INPUT_POST,'confirmado',FILTER_DEFAULT);
$idNEquip= filter_input(INPUT_POST,'nequipEdit',FILTER_DEFAULT);
$Disponivel= filter_input(INPUT_POST,'disponivel',FILTER_DEFAULT);
...
$b = $conex->prepare("UPDATE posvenda_treinamento SET 
                        ...
                        pedido = '$idPedido', id_uso = '$idUso', concluido = '$idconcluido', certificado = '$idcertificado', obs_treinamento = '$idObs', id_formato = '$idFormato', id_tipo = '$idTipo', confirmado = '$idConfirmado', nequip = '$idNEquip', disponivel = '$Disponivel'
