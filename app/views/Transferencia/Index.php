              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Transferência de Estoque</li>
                  </ol>
                </div>
                ...
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                  <div class="bookmark">
                    	<a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalcat" data-whatever="@mdo">Executar Transferência</a>
                  </div>
                  <!-- Bookmark Ends-->
                        ...
                        <div class="modal-content">
                          ...
                          <script>
                           function recalcula() {
                            ...
                            if(valor1 == valor2){
                             alert("Origem não pode ser igal ao destino");
                             return false;
                            } 
