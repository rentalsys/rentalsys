...
<div class="row">
<div class="col-sm-6">
<h3>Ordem de Compra Faturamento</h3>
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="<?php echo URL_BASE ?>">Home</a></li>
<li class="breadcrumb-item active">Ordem de Compra Faturamento</li>
</ol>
</div>
...
<div class="col-md-12 project-list">
                ...
                <div class="card-header">
                    <h5>ORDEM DE COMPRA N<sup>o</sup> <span id="id_pedido"><?php echo $ordem_compra->id_ordem_compra; ?></span></h5>
                  </div>
                
                      <div class="row g-3">
                      <div class="col-md-4 mb-3">
                      <span>FORNECEDOR</span>
 					  <h5><?php echo $ordem_compra->nome_fornecedor ?></h5>
                    
                        </div>

                        <div class="col-md-2 mb-3">
                        <span>DATA DE EMISSÃO</span>
                          <h5><?php echo date('d/m/Y', strtotime($ordem_compra->data_emissao)); ?></h5>
                        </div>
                        <div class="col-md-2 mb-3">
                        <span>DATA DA APROVAÇÃO</span>
                         <h5><?php echo ($ordem_compra->data_aprovacao)?date('d/m/Y', strtotime($ordem_compra->data_aprovacao)):null; ?></h5>
                      </div>
                        <div class="col-md-2 mb-3">
                        <span>VALOR TOTAL</span>
                          <h5>R$ <span id="total_oc"><?php echo number_format($ordem_compra->valor_total,2,",","."); ?></span></h5>
                        </div>
                        
                        <div class="col-md-2 mb-3">
                        <span>STATUS</span>
                          <h5><?php echo  $ordem_compra->status_ordem_compra; ?></h5>
                        </div>
                      </div>
                </div>
              </div>
                    ...
                    <h5>Dados do Pagamento</h5>
                      ...
                      <div class="col-md-3 mb-3">
 					  <label class="text-label">Documento Origem</label>
                        ...
                        <div class="col-md-2 mb-3">
                        <label class="text-label">Núm. Parcelas</label>
						<input type="number" name="numero_parcelas" id="numero_parcelas" value="5" class="form-control">
                        </div>
                        <div class="col-md-2 mb-3">
                      ...
                      <label class="text-label">Desconto</label>
						...
						<input type="submit" value="Faturar Ordem de Conta" class="btn btn-primary" />  		
                        </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive ">
                      <table class="table table-striped">
                        ...
                        <?php $i = 0; foreach ($itens as $item){ $i++; $total = $total + $item->subtotal; $qtotal = $qtotal + $item->qtde?>
                          <tr>
                          <td style="text-align:center"><?php echo $item->id_item_ordem_compra ?></td>
                           <td><?php echo $item->produto ?></td>
                            ...
                            <td style="text-align:center"><?php echo number_format($item->subtotal,2,",",".") ?></td>
