...
<li class="breadcrumb-item active">Ordens de Compra A Faturar</li>
</ol>
</div>
                          ...
                          <td style="text-align:center"><?php echo $oc->id_ordem_compra ?></td>
                           ...
                           <td><?php echo $oc->nome_fornecedor ?></td>
                            ...
                            <td style="text-align:center">
                              <a href="<?php echo URL_BASE ."financeiro/faturar_ordem_compra/".$oc->id_ordem_compra ?>" class="btn btn-primary">Faturar</a>                       
                            </td>
                          </tr>
                          <!-- Modal Editar-->
