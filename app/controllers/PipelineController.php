...
use app\models\service\PipelineService;
...
class PipelineController extends Controller{
    ...
    public function index(){
        ...
        $dados["enviados"] = PipelineService::enviado($this->tabela);
        $dados["faturados"] = PipelineService::faturado($this->tabela);
        $dados["view"]   = "Pipeline/index";
    ...
    public function create($id_pedido){
        $orcamento = PipelineService::getPipeline($id_pedido);
        $itens = PipelineService::getPipelineItem($id_pedido);
        $dados["orcamento_pedido"] = $orcamento;
        $dados["itenspedido"] = $itens;
        $dados["lista"] = Service::lista($this->tabela);
        $dados["view"] = "Pipeline/Create";
        $this->load("template", $dados);
    }
