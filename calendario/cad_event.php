...
(id_responsavel, data_inicio, data_fim, id_formato, id_ocupacao, id_usuario, id_produto, id_cliente, id_uso, pedido, concluido, obs_treinamento, certificado, id_tipo, confirmado) 
VALUE 
(:id_responsavel, :data_inicio, :data_fim, :id_formato, :id_ocupacao, :id_usuario, :id_produto, :id_cliente, :id_uso, :pedido, :concluido, :obs_treinamento, :certificado, :id_tipo, :confirmado)";
...
$insert_event->bindValue(':id_tipo',isset($_POST['id_tipo'])?$_POST['id_tipo']:3);
