                            ...
                            foreach($lista as $ordem){ ?>                                     
                             <tr>
                                <td align="center"><?php echo $ordem->id_ordem_compra?></td>
                                 ...
                                 <td align="center"><?php echo databr($ordem->data_aprovacao) ?></td>
                                ...
                                <td align="center">
                                	<a href="<?php echo URL_BASE ."financeiro/faturar_ordem_compra/" . $ordem->id_ordem_compra   ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Faturar</a>
                                 </td>
                             </tr>						 
							<?php } ?> 				 
