              ...
              <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
                <span class="d-flex center-middle"><i class="fas fa-arrow-right mr-1"></i>  Lista de pedidos para Faturar </span>
				 <div>
											...
											<table cellpadding="0" cellspacing="0" id="dataTable" class="mb-0 table-bordered">
												...
												<?php foreach($lista as $pedido){?>
													<tr>
														...
														<td align="center">	<a href="<?php echo URL_BASE ."financeiro/faturar_pedido/". $pedido->id_pedido?>" class="d-inline-block btn btn-verde btn-pequeno"> Faturar </a>	</td>
													 </tr> 
											    <?php }?> 
